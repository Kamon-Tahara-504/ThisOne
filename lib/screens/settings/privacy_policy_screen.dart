                ...
                child: DefaultTextStyle(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      Text('• 認証情報：Supabaseを通じた認証に必要なトークン等'),
                      ...
                      Text(
                        '• クラウドサービス：メールアドレスとパスワード等、認証に必要な最低限の情報のみをSupabaseがホストするサーバーに保存します。',
                      ),
                      Text(
                      ...
                      SizedBox(height: 8),
                      Text(
                        '• Supabase：ユーザー認証機能の提供。認証に必要なメールアドレス等が同サービス上で保存・処理されます。',
                      ),
                      SizedBox(height: 16),
                      Text(
                        '6. データの管理と削除',
                      ...
                      Text('• アカウントを削除すると、Supabase上に保存されている認証情報も削除されます。'),
