...
class _HelpScreenState extends State<HelpScreen> {
  ...
  final List<Map<String, String>> _faqItems = [
    ...
    },
    {
      ...
      'answer':
          '現在、削除したデータの自動復元機能はありません。重要なデータは削除前にデータ管理画面の「データをエクスポート」からバックアップを取ることをお勧めします。バックアップファイルがあれば、データ管理画面の「データをインポート」から復元できます。',
    },
    {
      'question': 'バックアップの作成方法は？',
      'answer':
          'データ管理画面の「データをエクスポート」ボタンから、現在のデータをJSONファイルとして保存できます。エクスポートしたファイルは他のアプリや端末と共有することも可能です。定期的にバックアップを作成することをお勧めします。',
    },
    {
      'question': 'バックアップから復元する方法は？',
      'answer':
          'データ管理画面の「データをインポート」ボタンから、バックアップファイルを選択してデータを復元できます。重複するデータは自動的にスキップされます。機種変更時にはエクスポート→インポートでデータ移行が可能です。',
    },
    {
      'question': 'バックアップファイルの安全性は？',
      'answer':
          'すべてのデータは端末内に保存され、外部サーバーには送信されません。バックアップファイルにはメモ、タスク、スケジュールなどのデータが含まれます。ファイルは安全な場所に保管し、他人に共有しないようご注意ください。',
    },
    {
