                  ...
                  onNotification: (notification) {
                    if (notification is ScrollEndNotification) {
                      ...
                      if (finalIndex < optionsLength ||
                          finalIndex > totalItems - optionsLength) {
                        final logicalIndex = toLogicalIndex(finalIndex);
                        final centered =
                            baseCycle * optionsLength + logicalIndex;
                        WidgetsBinding.instance.addPostFrameCallback((_) {
                          if (mounted && controller.hasClients) {
                            controller.jumpToItem(centered);
                          }
                        });
                      }
                    }
                      ...
                      builder: (context, index) {
                        ...
                        final currentCenter =
                            controller.hasClients
                                ? (controller.offset / _itemExtent).round()
                                : 0;
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            child: AnimatedDefaultTextStyle(
                              ...
                              child: Text(formatLabel(options[logicalIndex])),
                            ),
                          ),
                        );
                      },
                    ...
                    child: Align(
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          final currentIndex =
                              (controller.offset / _itemExtent).round();
                          final logicalIndex = toLogicalIndex(currentIndex);
                          return Text(
                            formatLabel(options[logicalIndex]),
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 18,
                              fontWeight: FontWeight.w600,
